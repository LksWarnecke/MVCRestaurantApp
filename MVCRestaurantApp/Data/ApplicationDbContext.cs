...
namespace MVCRestaurantApp.Data
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //making composite key out of multiple keys and relationships between tables
            ...
            modelBuilder.Entity<Ingredient>().HasData(
                ...
                new Ingredient { IngredientId = 6, Name = "Tomate" }
            );
            ...
            //linking products to their ingredients
