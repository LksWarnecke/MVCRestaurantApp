...
namespace MVCRestaurantApp.Controllers
{
	public class OrderController : Controller
	{
        ...
        {
            //Retrieve OrderViewModel from session or other state management
        ...
        public async Task<IActionResult> PlaceOrder()
        {
            ...
            //Add OrderItem to the Order entity
            ...
            //Clear OrderViewModel from session or other state management
        ...
        public async Task<IActionResult> ViewOrders()
        {
            ...
            {
                Includes = "OrderItems.Product" //include all products in OrderItems table
            });
